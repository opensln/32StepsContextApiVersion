...
class PatternContainerRightDrums extends Component {
    ...
    return (
        ...
        <div className="bar1Holder">
          <div className="rowHolder b1hhRowHolder">
            <div className="stepBtn hhStep">
              <input type="checkbox" id="b1hh1" value="1" />
            </div>
            <div className="stepBtn hhStep">
              <input type="checkbox" id="b1hh2" value="2" />
            </div>
            <div className="stepBtn hhStep">
              <input type="checkbox" id="b1hh3" value="3" />
            </div>
            <div className="stepBtn hhStep">
              <input type="checkbox" id="b1hh4" value="4" />
              <p><input type="checkbox" id="b1hh4Roll" /></p>
            </div>
            <div className="stepBtn hhStep even">
              <input type="checkbox" id="b1hh5" value="5" />
            </div>
            <div className="stepBtn hhStep even">
              <input type="checkbox" id="b1hh6" value="6" />
            </div>
            <div className="stepBtn hhStep even">
              <input type="checkbox" id="b1hh7" value="7" />
            </div>
            <div className="stepBtn hhStep even">
              <input type="checkbox" id="b1hh8" value="8" />
              <p><input type="checkbox" id="b1hh8Roll" /></p>
            </div>
            <div className="stepBtn hhStep">
              <input type="checkbox" id="b1hh9" value="9" />
            </div>
            <div className="stepBtn hhStep">
              <input type="checkbox" id="b1hh10" value="10" />
              <p><input type="checkbox" id="b1hh4Roll" /></p>
            </div>
            <div className="stepBtn hhStep">
              <input type="checkbox" id="b1hh11" value="11" />
            </div>
            <div className="stepBtn hhStep">
              <input type="checkbox" id="b1hh12" value="12" />
            </div>
            <div className="stepBtn hhStep even">
              <input type="checkbox" id="b1hh13" value="13" />
            </div>
            <div className="stepBtn hhStep even">
              <input type="checkbox" id="b1hh14" value="14" />
            </div>
            <div className="stepBtn hhStep even">
              <input type="checkbox" id="b1hh15" value="15" />
            </div>
            <div className="stepBtn hhStep even">
              <input type="checkbox" id="b1hh16" value="16" />
              <p><input type="checkbox" id="b1hh4Roll" /></p>
            </div>
          </div>
        ...
        <div className="bar2Holder">
          <div className="rowHolder b2hhRowHolder">
            <div className="stepBtn hhStep">
              <input type="checkbox" id="b2hh1" value="17" />
            </div>
            <div className="stepBtn hhStep">
              <input type="checkbox" id="b2hh2" value="18" />
            </div>
            <div className="stepBtn hhStep">
              <input type="checkbox" id="b2hh3" value="19" />
            </div>
            <div className="stepBtn hhStep">
              <input type="checkbox" id="b2hh4" value="20" />
              <p><input type="checkbox" id="b1hh4Roll" /></p>
            </div>
            <div className="stepBtn hhStep even">
              <input type="checkbox" id="b2hh5" value="21" />
            </div>
            <div className="stepBtn hhStep even">
              <input type="checkbox" id="b2hh6" value="22" />
            </div>
            <div className="stepBtn hhStep even">
              <input type="checkbox" id="b2hh7" value="23" />
            </div>
            <div className="stepBtn hhStep even">
              <input type="checkbox" id="b2hh8" value="24" />
              <p><input type="checkbox" id="b2hh8Roll" /></p>
            </div>
            <div className="stepBtn hhStep">
              <input type="checkbox" id="b2hh9" value="25" />
            </div>
            <div className="stepBtn hhStep">
              <input type="checkbox" id="b2hh10" value="26" />
              <p><input type="checkbox" id="b2hh10Roll" /></p>
            </div>
            <div className="stepBtn hhStep">
              <input type="checkbox" id="b2hh11" value="27" />
            </div>
            <div className="stepBtn hhStep">
              <input type="checkbox" id="b2hh12" value="28" />
            </div>
            <div className="stepBtn hhStep even">
              <input type="checkbox" id="b2hh13" value="29" />
            </div>
            <div className="stepBtn hhStep even">
              <input type="checkbox" id="b2hh14" value="30" />
            </div>
            <div className="stepBtn hhStep even">
              <input type="checkbox" id="b2hh15" value="31" />
            </div>
            <div className="stepBtn hhStep even">
              <input type="checkbox" id="b2hh16" value="32" />
              <p><input type="checkbox" id="b1hh4Roll" /></p>
            </div>
          </div>
...
export default PatternContainerRightDrums;
